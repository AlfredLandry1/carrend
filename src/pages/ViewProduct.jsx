...
import car from "../assets/images/products/slideShow/card.png";
import car2 from "../assets/images/products/slideShow/card2.png";
        ...
        <section className="container py-5">
          <div className="d-flex justify-content-between align-items-end py-5">
            <h2
              ...
              title="Ferrari 488 GTB - Informations"
            >
              Ferrari 488 GTB - Informations
            </h2>
          ...
          <div className="p-3 p-lg-5 rounded-4 bg-light">
            <div>
              <div className="d-flex justify-content-between align-items-end">
                ...
                <h6 className="fw-bolder text-truncate" title="3 000 000 000">
                  3 000 000 000 FCFA
                </h6>
              </div>
              <div
                    ...
                    <div className="card-body">
                      ...
                      <div>
                        ...
                        <div className="d-flex flex-nowrap align-items-center gap-2">
                          ...
                          <p className="text-truncate">Ferrari</p>
                        </div>
                        <div className="d-flex flex-nowrap align-items-center gap-2">
                          <p className="text-black fw-bold">Model :</p>
                          <p className="text-truncate">408 GTB</p>
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                <div>
                  ...
                  >
                    <motion.div whileHover={{ scale: 0.8 }}>
                      <span className="fs-4 bi bi-cart-plus-fill"></span> ADD TO
                      CART
                    </motion.div>
                  </Link>
                </div>
